...
int SCE_Geometry_ComputeNormals (SCEvertices*, SCEindices*, size_t, size_t,
                                 SCEvertices*);
int SCE_Geometry_GenerateNormals (SCE_SGeometry*, SCEvertices**);
int SCE_Geometry_AddGenerateNormals (SCE_SGeometry*);
